...
docker-compose -f ${DOORS_SERVER_MONOLITH_PATH}/docker-compose.${DEPLOYMENT_ENVIRONMENT}.yml --env-file ${DOORS_SERVER_MONOLITH_PATH}/.env.${DEPLOYMENT_ENVIRONMENT} down
